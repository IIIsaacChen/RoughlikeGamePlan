...
cc.Class({
    ...
    start () {
        ...
        this.schedule(function(){
            this.createEnermyBomb()
        },variables.enermyBombFrequency,'enermyBomb')
        //敌人成长
        this.schedule(function(){
    ...
    createEnermyBomb(){
        var enermyBomb = cc.instantiate(this.enermy[1])
        this.node.addChild(enermyBomb)
        //在地图边缘生成
        var ram1 = Math.random()*2-1
        var ram2 = Math.random()*2-1
        var ram3 = Math.random()*2-1
        ...
        enermyBomb.setPosition(ram1*this.canvasWidth/2,ram2*this.canvasHeight/2)
        // enermyBomb.setPosition(Math.random()*this.canvasWidth-this.canvasWidth/2,Math.random()*this.canvasHeight-this.canvasHeight/2)
    },
    createItem(){
    ...
    bossStage(){
        ...
        setTimeout(function(){
            warning.destroy()
            var boss = cc.instantiate(self.boss[1])
            self.node.addChild(boss)
            boss.setPosition(0,0)
            boss.getComponent('boss2Bonfire').game = self
        },2000)
